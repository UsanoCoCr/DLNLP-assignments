...
class ModelArguments:
    ...
    # res:3, acl:6, agn:4
    num_labels: int = field(default=3, metadata={"help": "Number of labels for classification"})
...
class TrainingConfig:
    ...
    run_name: str = field(default="adapter_res_run1", metadata={"help": "Name of this WandB run"})
...
model.add_classification_head(adapter_name, num_labels=model_args.num_labels, activation_function="relu")
